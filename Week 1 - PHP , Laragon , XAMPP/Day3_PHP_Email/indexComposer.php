...
/*     $phpmailer = new PHPMailer();
    ...
    $phpmailer->Port = 2525;
    $phpmailer->Username = 'e3da2509c37e09';
    $phpmailer->Password = '61738adcf78aed'; */  //COPIATO DA MAILTRAP

    //Recipients
    $mail->setFrom('nostraemail', 'Mailer');
    $mail->addAddress('destinatario1', 'Joe User');     //Add a recipient
